...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.maxWeight_2 = QLineEdit(self.grBmaxwei_2)
        self.maxWeight_2.setObjectName(u"maxWeight_2")
        self.maxWeight_2.setGeometry(QRect(30, 20, 171, 31))
        self.maxWeight_2.setMouseTracking(False)
        self.maxWeight_2.setReadOnly(True)
